    ...
    return (
       <>
        ...
        <div className="flex flex-col items-center py-10 w-[304px]">
            ...
            <span className="text-xl mt-2">Thanks your feedback!</span>
            <button
                type="button"
                onClick={onFeedbackRestartRequested}
                className="py-2 px-6 mt-6 bg-zinc-800 rounded-md text-sm leading-6 hover:bg-zinc-700 focus:outline-none focus:ring-offset-zinc-900 focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 transition-colors disabled:opacity-50 disabled:hover:to-brand-500 "
            >
                I want sending other..
            </button>
        </div>
       </>
    )
